...
def wdlogin(): 
    ...
    USN.place(x=55,y=240,width=220,height=25)

    global passw
    global PW
    passw=StringVar()
    PW = Entry(root,textvariable=passw)
    PW.place(x=55,y=300,width=220,height=25)

    #Button create
    username=Label(text="Username",font=15,fg="#fcffff",bg="#1c252a").place(x=50,y=210)
    password=Label(text="Password",font=15,fg="#fcffff",bg="#1c252a").place(x=50,y=266)
...
def wdcategories():
  ...
  p1=Button(categories,image=photo_home, borderwidth=0 ,command=exitca).place(x=150,y=540,height=50,width=50)
  #สร้างปุ่ม
...
def rbook1():
    ...
    b1.title("Book1")
    b1.geometry("350x600")
    my_text = Text(b1,width=350,height=600,font=10)
    my_text.pack()
...
def wpage3():
    ...
    Label(page3,text="fantasy",font=('Athiti',15,'bold'),fg="#1c252a").place(x=100,y=20,width=150)
...
def rbook3():
    ...
    b3.title("Book3")
    b3.geometry("350x600")
    my_text = Text(b3,width=350,height=600,font=10)
    my_text.pack()
...
def wpage4():
    ...
    Label(page4,text="fantasy",font=('Athiti',15,'bold'),fg="#1c252a").place(x=100,y=20,width=150)
...
def rbook4():
    ...
    b4.title("Book4")
    b4.geometry("350x600")
    my_text = Text(b4,width=350,height=600,font=10)
    my_text.pack()
...
def rbook5():
    ...
    b5.title("Book5")
    b5.geometry("350x600")
    my_text = Text(b5,width=350,height=600,font=10)
    my_text.pack()
...
def wdhome():
  ...
  b1=Button(home, text = "Categories",bg="#737373",command=wdcategories).place(x=10,y=5)
  book1=PhotoImage(file="ปก1.png")
  p1=Button(home,image=book1, borderwidth=0).place(x=10,y=410,height=165,width=116)
  book2=PhotoImage(file="ปก2.png")
  p2=Button(home,image=book2, borderwidth=0).place(x=160,y=410,height=165,width=116)
  book3=PhotoImage(file="ปก3.png")
  p3=Button(home,image=book3, borderwidth=0).place(x=310,y=410,height=165,width=116)
  
  bookre=PhotoImage(file="ปก1.png")
  prepare_class=Label(home,image=book1, borderwidth=0).place(x=115,y=90,height=165,width=116)
  
  bread=Button(home, text = "Read",bg="#737373" ).place(x=155,y=260)
...
# button ปุ่มกด
    logout = Button(User, text= 'Logout' , command = exitprogram ).place(x=150,y=550,height=50,width=50)
    User.mainloop()
...
def wdcreateaccount():
    ...
    username=Label(createacc,text="Username",font=('Athiti',15),fg="#fcffff",bg="#1c252a").place(x=50,y=170)
    global txtun
    global etusername
    txtun=StringVar()
    etusername=Entry(createacc,textvariable=txtun)
    etusername.place(x=50,y=200,width=250)

    password=Label(createacc,text="Password",font=('Athiti',15),fg="#fcffff",bg="#1c252a").place(x=50,y=220)
    global txtpw
    global etpw
    txtpw=StringVar()
    etpw=Entry(createacc,textvariable=txtpw)
    etpw.place(x=50,y=245,width=250)

    cfpassword=Label(createacc,text="Confirm Password",font=('Athiti',15),fg="#fcffff",bg="#1c252a").place(x=50,y=265)
    global txtpw2
    global etcfpw
    txtpw2=StringVar()
    etcfpw=Entry(createacc,textvariable=txtpw2)
    etcfpw.place(x=50,y=290,width=250)

    email=Label(createacc,text="E-mail",font=('Athiti',15),fg="#fcffff",bg="#1c252a").place(x=50,y=310)
    global txtem
    global etem
    txtem=StringVar()
    etem=Entry(createacc,textvariable=txtem)
    etem.place(x=50,y=335,width=250)

    phonenum=Label(createacc,text="Phone number",font=('Athiti',15),fg="#fcffff",bg="#1c252a").place(x=50,y=355)
    global txtphnum
    global etpn
    txtphnum=StringVar()
    etpn=Entry(createacc,textvariable=txtphnum)
    etpn.place(x=50,y=380,width=250)
